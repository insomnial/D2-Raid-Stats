...
class WeaponReport(Report):
    ...
    def save(self):
        with open("%s/%s.html" % (LocalController.GetResultDirectory(self.displayName), "[ALL] table - weapons used per activity type"), "w") as f:
        ...
        with open("%s/%s.csv" % (LocalController.GetResultDirectory(self.displayName), "[ALL] table - weapons used per activity type"), "w") as f:
